...
define internal void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17hfa10f75e9c3f9352E"(i32* align 4 %self, i32* align 4 %other) unnamed_addr #0 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h06c57291f243714fE([0 x i8]* align 1 bitcast ([28 x i8]* @str.0 to [0 x i8]*), i64 28, %"core::panic::location::Location"* align 8 bitcast (<{ i8*, [16 x i8] }>* @alloc6 to %"core::panic::location::Location"*)) #5
  unreachable
}
...
; call <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
  call void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17hfa10f75e9c3f9352E"(i32* align 4 %x, i32* align 4 bitcast (<{ [4 x i8] }>* @alloc3 to i32*))
  br label %bb1
...
declare void @_ZN4core9panicking5panic17h06c57291f243714fE([0 x i8]* align 1, i64, %"core::panic::location::Location"* align 8) unnamed_addr #4
